...
class Game {
            ...
            intro: {
                ...
                choices: [
                    ...
                    { 
                        ...
                        items: [{ id: 'flashlight', name: 'Фонарик', icon: '🔦' }]
                    }
                ]
            },
            chapter2: {
    ...
    makeChoice(choiceIndex) {
        ...
        if (chapter.choices && chapter.choices[choiceIndex]) {
            ...
            if (choice.effects) {
                // Если переданы текстовые статусы
                if (choice.effects.mental || choice.effects.physical || choice.effects.emotional) {
                    this.updateStatus(choice.effects);
                } 
                // Если переданы числовые значения (для обратной совместимости)
                else if (choice.effects.morale !== undefined || choice.effects.stamina !== undefined || choice.effects.emotional !== undefined) {
